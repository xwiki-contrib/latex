 ...
 * <p>
 * TODO: Remove when the LaTeX extension starts depending on XWiki >= 12.9RC1
 * (see https://jira.xwiki.org/browse/XWIKI-17961)
 *
 * @version $Id$
 */
public class LaTeXXWikiServletRequestStub implements XWikiRequest
{
     ...
     * @since 11.0
     */
    public LaTeXXWikiServletRequestStub(URL requestURL, String contextPath, Map<String, String[]> requestParameters)
    {
        if (requestURL != null) {
