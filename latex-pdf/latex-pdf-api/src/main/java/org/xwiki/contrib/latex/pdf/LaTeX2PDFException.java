...
/**
 * Any exception raised when converting from LaTeX to PDF.
 *
 * @version $Id$
 * @since 1.10
 */
@Unstable
public class LaTeX2PDFException extends Exception
{
    /**
     ...
     */
    public LaTeX2PDFException(String message)
    {
        super(message);
    }
     ...
     */
    public LaTeX2PDFException(String message, Throwable cause)
    {
        super(message, cause);
    }
}
