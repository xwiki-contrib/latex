 ...
 * conventions described in {@link ExtendedTestDataParser}.
 * <p>Usage Example</p>
 * <pre>
 * <code>
 * {@literal @}RunWith(ExtendedRenderingTestSuite.class)
 ...
 * public class IntegrationTests
 * {
 *     {@literal @}ExtendedRenderingTestSuite.Initialized
 ...
 * </pre>
 *
 * @version $Id: 09aa1a334660babe7513c063723ffe91af653f6d $
 * @since 3.0RC1
 */
public class ExtendedRenderingTestSuite extends Suite
{
    private static final ExtendedTestDataGenerator GENERATOR = new ExtendedTestDataGenerator();
        ...
        BlockJUnit4ClassRunner
    {
        ...
        private Object[] computeParams() throws Exception
        {
            ...
            // Remove the first parameter which is the test name and that is not needed in ExtendedRenderingTester
        ...
        protected void runChild(FrameworkMethod method, RunNotifier notifier)
        {
            ...
            try {
                for (Method klassMethod : ExtendedRenderingTestSuite.this.klassInstance.getClass().getMethods()) {
                    Initialized componentManagerAnnotation = klassMethod.getAnnotation(Initialized.class);
                    if (componentManagerAnnotation != null) {
                        // Call it!
                        klassMethod.invoke(ExtendedRenderingTestSuite.this.klassInstance, getComponentManager());
                    }
                }
            } catch (Exception e) {
        ...
        private void initializeComponentManager(RunNotifier notifier)
        {
            try {
                if (isLegacyMode()) {
                    ...
                    this.mockitoComponentManager.initializeTest(ExtendedRenderingTestSuite.this.klassInstance);
        ...
        private boolean isLegacyMode()
        {
            ...
            if (isLegacyMode
                && (ExtendedRenderingTestSuite.this.klassInstance.getClass().getAnnotation(AllComponents.class) != null
                || ExtendedRenderingTestSuite.this.klassInstance.getClass().getAnnotation(ComponentList.class) != null))
            {
                isLegacyMode = false;
            }
     ...
     */
    public ExtendedRenderingTestSuite(Class<?> klass) throws Throwable
    {
        ...
        for (int i = 0; i < parametersList.size(); i++) {
            this.runners.add(new TestClassRunnerForParameters(ExtendedRenderingTester.class, parametersList, i));
        }
    }
     ...
     * result for each node (as it would be otherwise since ExtendedRenderingTester has a single test method).
     */
    @Override
