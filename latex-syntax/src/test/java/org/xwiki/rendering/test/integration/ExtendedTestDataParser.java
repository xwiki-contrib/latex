 ...
 *
 * @version $Id: 0f359d14e5aae669f33aa786431ce81ef6f0832a $
 * @since 3.0RC1
 */
public class ExtendedTestDataParser
{
    private final static String TRANSFORMATION_PREFIX = ".runTransformations";

    public ExtendedTestData parse(InputStream source, String resourceName) throws IOException
    {
        ExtendedTestData data = new ExtendedTestData();
    ...
    private void saveData(String action, StringBuffer buffer, ExtendedTestData data, String keyName)
    {
        if (action != null) {
